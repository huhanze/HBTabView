...
@interface HBHorizontalViewController ()

@end

@implementation HBHorizontalViewController
...
//    self.navigationController.navigationBarHidden = YES;
    ...
    HBTabView *tabView = [[HBTabView alloc] initWithFrame:CGRectMake(0, 64, self.view.bounds.size.width, self.view.bounds.size.height - 64) parentViewController:self showType:HBTabViewShowTypeHorizontal];
    [self.view addSubview:tabView];
    tabView.titleSelectedColor = [UIColor orangeColor];
    tabView.indicatorColor = [UIColor greenColor];
